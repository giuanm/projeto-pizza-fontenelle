...
// Codigo para links de redes sociais
$("ion-icon#insta").click(function(){
...
$("div#transicao-testemunha-plano").waypoint(function(direcao){
    if(direcao=="down"){
        ...
        $("div#decoracao2").addClass("animate__animated animate__fadeInDown animate__slow");
...
$("footer").waypoint(function(direcao){
    if(direcao=="down"){
        $("div#mapa").addClass("animate__animated animate__fadeIn animate__slow");
        $("div#info").addClass("animate__animated animate__fadeIn animate__slow");
        $("div#pizza-rodape-decoracao").addClass("animate__animated animate__fadeIn animate__slower");
    } else {
        $("div#mapa").removeClass("animate__animated animate__fadeIn animate__slow");
        $("div#info").removeClass("animate__animated animate__fadeIn animate__slow");
        $("div#pizza-rodape-decoracao").removeClass("animate__animated animate__fadeIn animate__slower");
    }
}, {
    offset: "800px;"
})
